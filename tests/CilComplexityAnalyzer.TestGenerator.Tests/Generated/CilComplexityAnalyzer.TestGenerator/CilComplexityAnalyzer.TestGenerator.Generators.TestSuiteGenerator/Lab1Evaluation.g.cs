...
public partial class Lab1Evaluation
{
    ...
    public partial class Student1
    {
        ...
        public void Case6()
        {
            var ok = FakeExecutor.Run(@"Submissions/student1.cs", "Solve", "Case6", new object[] { 3, 3 }, new object[] { 6 });
            Assert.IsTrue(ok);
        }
        [TestMethod]
        public void Case7()
        {
            var ok = FakeExecutor.Run(@"Submissions/student1.cs", "Solve", "Case7", new object[] { 3, 3 }, new object[] { 6 });
            Assert.IsTrue(ok);
        }
        [TestMethod]
        public void Case8()
        {
            var ok = FakeExecutor.Run(@"Submissions/student1.cs", "Solve", "Case8", new object[] { 3, 3 }, new object[] { 6 });
            Assert.IsTrue(ok);
        }
    }
    [TestClass]
